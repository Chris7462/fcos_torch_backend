...
add_custom_command(
  ...
  COMMAND ${CMAKE_COMMAND} -E create_symlink
          ${MODEL_PATH}
          ${MODEL_LINK_PATH}
  DEPENDS fcos_torch_backend  # Depend on the main library target so it won't build before the engine is generated
  COMMENT "Creating symbolic link to script file for testing: ${MODEL_FILE}..."
)
